...
const TicketSelector: FC<Props> = ({ isLoggedIn = false, onChange }) => {
  ...
  const prices = {
    ordinary: 140,
    child: 140 * 0.8, // 20% discount
    retired: 140 * 0.8, // 20% discount
  ...
  return (
    <div className='m-auto p-4 md:p-8 pb-6 space-y-6 bg-gray-900 border-4 border-yellow-400 shadow-[inset_0_0_10px_#facc15,0_0_20px_#facc15] max-w-[720px]'>
        ...
        <>
          <div className='bg-gray-800 p-3 rounded'>
            <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
              <div className='text-center sm:text-left'>
                <span id='label-ordinary' className='text-lg'>
                  Ordinarie
                </span>
              </div>
              <div className='flex justify-center sm:justify-start items-center gap-2'>
                <button
                  ...
                  onClick={() => setOrdinary(Math.max(ordinary - 1, 0))}
                  className='bg-gray-600 px-2 rounded hover:border-white border border-transparent'
                >
                  −
                </button>
                <span>{ordinary}</span>
                <button
                  ...
                  onClick={() => setOrdinary(ordinary + 1)}
                  className='bg-yellow-400 text-black px-2 rounded hover:border-white hover:bg-yellow-300 border border-transparent'
                >
                  +
                </button>
              </div>
          ...
          <div className='bg-gray-800 p-3 rounded'>
            <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4'>
              <div className='text-center sm:text-left'>
                <span id='label-child' className='text-lg block'>
                  Barn
                </span>
                <span className='block text-gray-400 text-sm'>
                  (20% rabatt för barn under 11 år)
                </span>
              </div>
              <div className='flex justify-center sm:justify-start items-center gap-2'>
                <button
                  aria-label='Minska antal barnbiljetter'
                  onClick={() => setChild(Math.max(child - 1, 0))}
                  className='bg-gray-600 px-2 rounded border border-transparent hover:border-white'
                >
                  −
                </button>
                <span>{child}</span>
                <button
                  ...
                  className='bg-yellow-400 text-black px-2 rounded border border-transparent hover:border-white hover:bg-yellow-300'
                >
                  +
                </button>
              </div>
          ...
          <div className='bg-gray-800 p-3 rounded'>
            <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4'>
              <div className='text-center sm:text-left'>
                <span id='label-retired' className='text-lg block'>
                  Pensionär
                </span>
                <span className='block text-gray-400 text-sm'>
                  (20% rabatt)
              ...
              <div className='flex justify-center sm:justify-start items-center gap-2'>
                <button
                  ...
                  onClick={() => setRetired(Math.max(retired - 1, 0))}
                  className='bg-gray-600 px-2 rounded border border-transparent hover:border-white'
                >
                  −
                </button>
          ...
          <div className='bg-gray-800 p-3 rounded'>
            <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4'>
              <div className='text-center sm:text-left'>
                <span id='label-student' className='text-lg block'>
                  Student
                </span>
                <span className='block text-gray-400 text-sm'>
                  (15% rabatt)
              ...
              <div className='flex justify-center sm:justify-start items-center gap-2'>
                <button
                  ...
                  onClick={() => setStudent(Math.max(student - 1, 0))}
                  className='bg-gray-600 px-2 rounded border border-transparent hover:border-white'
                >
                  −
                </button>
      ...
      <div className='bg-gray-800 p-3 rounded'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4'>
          <div className='text-center sm:text-left'>
            <span id='label-member' className='text-lg block'>
              Medlem
            </span>
          ...
          <div className='flex justify-center sm:justify-start items-center gap-2'>
            <button
              ...
              className={`px-2 rounded cursor-pointer border border-transparent ${
                isLoggedIn
