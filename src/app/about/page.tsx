    ...
    <div className='max-w-4xl mx-auto px-6 py-12 space-y-16 text-center'>
      ...
      <div className=' border-4 rounded-md border-yellow-400 shadow-[inset_0_0_10px_#facc15,0_0_20px_#facc15] flex flex-col gap-6 px-4 py-8 bg-[#250303] p-6 rounded-2xl'>
        <section className='pl-10 pr-10'>
          <h2 className='text-2xl font-bold text-[#CDCDCD] mb-4'>
            Din lokala biograf
          </h2>
          <p className='text-[#CDCDCD] leading-relaxed'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum
            vel sem sit amet nulla lacinia viverra. Nulla facilisi. Pellentesque
            habitant morbi tristique senectus et netus et malesuada fames ac
            turpis egestas. Lorem ipsum dolor sit amet, consectetur adipiscing
            elit. Duis porta libero a malesuada fermentum. Curabitur nec urna at
            felis lacinia volutpat non sit amet erat.
          </p>
        </section>
      </div>
      ...
      <section className='border-4 rounded-md border-yellow-400 shadow-[inset_0_0_10px_#facc15,0_0_20px_#facc15] flex flex-col gap-6 px-4 py-8 bg-[#250303] p-6 rounded-2xl'>
        <h3 className='text-2xl font-bold text-[#CDCDCD] mb-2'>
          Kontaktinformation
        </h3>
